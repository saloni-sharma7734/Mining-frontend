...
import BallClayImage from '../images/ball-clay.jpg';
import './kaolin.css'; 
const Ballclay = () => {
  return (
    <div>
      ...
      <section id="introduction">
        <div className="image-container">
          <img src={BallClayImage} alt="BallClay mining" height={'300px'} />
        </div>
        <div className="text-container">
          <h2>BallClay Details</h2>
          <p>
            ...
            <div className="card ">
              <div className="card-body">
                ...
                <p className="card-text">
                  BallClay, with its unique properties, contributes to the strength and brilliance of ceramics.
                </p>
          ...
          <div className="col-sm-3">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  BallClay acts as a reinforcing agent, enhancing the strength and stiffness of plastic products.
                </p>
                {/* <a href="#" className="btn btn-primary">
                  Buy
                </a> */}
          ...
          <div className="col-sm-3">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  Utilize BallClay as a functional extender for improved durability and texture in paints.
                </p>
                {/* <a href="#" className="btn btn-primary">
                  Buy
                </a> */}
